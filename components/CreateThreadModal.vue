                ...
                <UForm @submit="handleCreateThread">
                    <div class="flex flex-col space-y-4">
                        <UFormGroup label="Name" label-for="name">
                            <UInput id="name" :required="true" v-model="name" placeholder="Enter a name for the chat" />
                        </UFormGroup>
                        ...
                        <div class="flex gap-2 justify-between">
                            ...
                            <UFormGroup label="Max Tokens">
                                <UInput id="maxTokens" v-model="maxTokens" type="number" min="10"
                        ...
                        <UButton block type="submit" color="primary">
                            Create
                        </UButton>
